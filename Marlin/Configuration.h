...
#define STRING_CONFIG_H_AUTHOR "LinFor" // Who made the changes.
...
// Choose the name from boards.h that matches your setup
  ...
  #define FAN1_PIN            -1      // CONTROLLER_FAN
  #define FAN2_PIN            -1      // HEATER_BED control
  #define X_MIN_PIN           -1      // Filament runout
  #define X_MAX_PIN           -1      // Extruder FAN0 control
  #define Y_MIN_PIN           -1      // MAX6675 CS

  #define E0_AUTO_FAN_PIN     PB0     // FAN0 socket
  #define CASE_LIGHT_PIN      PB1     // FAN1 socket
  #define HEATER_BED_PIN      PB2     // FAN2 socket
  #define FIL_RUNOUT_PIN      PB14    // X_MIN socket
  #define FAN_PIN             PA1     // X_MAX socket
  #define MAX6675_SS_PIN      PB13    // Y_MIN socket
...
#define CUSTOM_MACHINE_NAME "E-bot"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "e036ea7f-ac56-4adf-86c7-6965fd89f241"
 ...
 */
#define TEMP_SENSOR_0 -2 // Not dummy!
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // E-bot
    #define DEFAULT_Kp 11.99
    #define DEFAULT_Ki 0.85
    #define DEFAULT_Kd 42.20
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define PID_BED_FUNCTIONAL_RANGE 15 // If the temperature difference between the target temperature and the actual temperature
                                      // is more than PID_FUNCTIONAL_RANGE then the PID will be shut off and the heater will be set to min/max.

  // E-bot with glass
  #define DEFAULT_bedKp 58.69
  #define DEFAULT_bedKi 8.06
  #define DEFAULT_bedKd 284.84
#endif // PIDTEMPBED
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 800, 800, 1600, 6400 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 100, 200 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 500, 500, 100, 200 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 1500, 1500, 200, 10000 } // ...or, set your own edit limits
#endif
...
//#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING          // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 30, 30, 1, 20 } // ...or, set your own edit limits
  #endif
#endif
...
#define Y_MIN_POS   -9
#define Z_MIN_POS    0
#define X_MAX_POS  339
#define Y_MAX_POS  324
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_COLOR { 255, 255, 176, 0 }   // R, G, B, W
#endif
