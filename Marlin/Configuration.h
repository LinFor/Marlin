 ...
 */
#define TEMP_SENSOR_0 998 // Not dummy!
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // E-bot with glass
  #define DEFAULT_bedKp 34.39
  #define DEFAULT_bedKi 4.04
  #define DEFAULT_bedKd 195.16
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_Z_HOP  8.0  // (mm) Move nozzle up before moving between corners
