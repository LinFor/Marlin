 ...
 */
//#define E0_AUTO_FAN_PIN PB0 // See BOARD section
...
#define SENSORLESS_BACKOFF_MM  { 15, 15 }       // (mm) Backoff from endstops before sensorless homing
...
#define HOMING_BACKOFF_POST_MM { (-X_MIN_POS), (-Y_MIN_POS), 2 }    // (mm) Backoff from endstops after homing
...
#define DEFAULT_MINSEGMENTTIME        100     // (µs) Set with M205 B.
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 20*60, 10*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define FWRETRACT
  ...
  #define RETRACT_LENGTH_SWAP 40          // (mm) Default swap retract length (positive value)
 ...
 */
   ...
   */
  #define SENSORLESS_HOMING 1 // StallGuard capable drivers only
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Go to Z-Max"
  #define USER_GCODE_1 "G90\nG1 Z" STRINGIFY(Z_MAX_POS) " F2000"

  #define USER_DESC_2 "Move head to center"
  #define USER_GCODE_2 "G90\nG1 X165 Y165 F2000"

  #define USER_DESC_3 "Preheat bed"
  #define USER_GCODE_3 "M140 S60"

  #define USER_DESC_4 "Remove filament+heat"
  #define USER_GCODE_4 "M109 S130\nM702\nM104 S190"
